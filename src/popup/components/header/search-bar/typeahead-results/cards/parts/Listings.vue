...
import ListingsPopover from '~/popup/components/header/search-bar/typeahead-results/cards/parts/ListingsPopover.vue'
...
<template>
  <div class="relative inline-flex items-center" @click.stop>
    ...
    <!-- Fallback static icon if no additional listings -->
    <BaseIcon
      v-else
      :icon="Store"
